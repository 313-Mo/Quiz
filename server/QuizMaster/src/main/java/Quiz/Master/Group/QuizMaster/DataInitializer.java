...
public class DataInitializer {
    ...
    public CommandLineRunner initData(QuizRepository quizRepo, QuestionRepository questionRepo) {
        return args -> {
            ...
            MultipleChoiceQuiz muChoQuizchem = new MultipleChoiceQuiz("Default Quiz Chemistry", "Chemistry", 10, 10, chemistryQuiz);
            ...
            MultipleChoiceQuiz muChoQuizcs = new MultipleChoiceQuiz("Default Quiz Computer Science", "Computer Science", 10, 10, csQuiz);
            ...
            MultipleChoiceQuiz muChoQuizgeo = new MultipleChoiceQuiz("Default Quiz Geography", "Geography", 10, 10, geoQuiz);
            ...
            MultipleChoiceQuiz muChoQuizhistory = new MultipleChoiceQuiz("Default Quiz History", "History", 10, 10, historyQuiz);
        ...
        MultipleChoiceQuiz muChoQuizgeneralKnowledge = new MultipleChoiceQuiz("Default Quiz General Knowledge", "General Knowledge", 10, 10, generalKnowledgeQuiz);
        ...
        MultipleChoiceQuiz muChoQuizbiology = new MultipleChoiceQuiz("Default Quiz Biology", "Biology", 10, 10, biologyQuiz);
        ...
        MultipleChoiceQuiz muChoQuizfinance = new MultipleChoiceQuiz("Default Quiz Finance", "Finance", 10, 10, financeQuiz);
        ...
        MultipleChoiceQuiz muChoQuizmath = new MultipleChoiceQuiz("Default Quiz Mathematics", "Mathematics", 10, 10, mathQuiz);
